...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,512,416,122],[0,0,461,254],[418,512,416,122],[463,0,461,254],[0,636,416,122],[0,256,461,254],[418,636,416,122],[463,256,461,254]]}
];
...
p.nominalBounds = new cjs.Rectangle(-0.5,-0.5,230.5,127);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(320.05,240.55,1,1,0,0,0,114.7,63.1);
...
p.nominalBounds = new cjs.Rectangle(524.9,417,-89.5,-113);
// library properties:
lib.properties = {
	id: '33C032B5D5EFEE46B52BAAE2E4A1421F',
	width: 640,
	height: 480,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['33C032B5D5EFEE46B52BAAE2E4A1421F'] = {
